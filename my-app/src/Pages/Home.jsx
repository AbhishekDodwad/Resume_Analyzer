...
// // import { FaUpload, FaFileAlt, FaClipboardCheck } from 'react-icons/fa';
...
// //                 <h1><FaClipboardCheck style={{ marginRight: "10px", color: "#ff4b2b" }} />
// //                     Optimize Your Resume for Every Job
// //                 </h1>

// //                 <h2>
// //                     Upload your resume and the job description to get an ATS compatibility
// //                     <br />
// //                     score and actionable improvement suggestions.
// //                 </h2>
...
// //                             <FaFileAlt style={{ marginRight: "8px", color: "#ff416c" }} />
// //                             Resume:
// //                         </label>
...
// //                             Job Description:
// //                         </label>
// //                         <input type="file" name="jobDescription" id="jobDescription" /><br />
// //                         <p>OR</p>
// //                         <br />
...
// //                         </label><br />
// //                         <textarea name="jdText" id="jdText" ></textarea><br /><br />


// //                         <button type="submit">
// //                             <FaUpload style={{ marginRight: "8px" }} /> Analyze My Resume
// //                         </button>
// //                     </form>
// //                 </div>
...
// import Navbar from '../Components/Navbar';
// import '../assets/Home.css'
// import { FaUpload, FaFileAlt, FaClipboardCheck, FaStar, FaChartBar, FaLightbulb, FaShieldAlt, FaRocket } from 'react-icons/fa';
// import Footer from '../Components/Footer';
...
//             console.log("The matched skills are :", result.matchedSkills[0]);
...
//                                     Upload Your Resume:
//                                 </label>
//                                 <input onChange={handelResumeFileChange} type="file" name="resume" id="resume" accept=".pdf,.doc,.docx" />
...
//                             <button onClick={handelSubmit} type="submit" className="cta-button">
...
//                         <h2>Results</h2>
//                         <div className='matched-skills'>{result?.map((e) => {
//                             <div><li>
//                                 {e.matchedSkills}
//                             </li></div>
//                         })}</div>
